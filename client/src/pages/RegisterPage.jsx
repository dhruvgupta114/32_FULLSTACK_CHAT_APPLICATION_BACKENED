...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const URL = `${import.meta.env.VITE_REACT_APP_BACKENED_URL}/api/register`;
    ...
    <div className="mt-5">
      <div className="bg-white w-full max-w-md  rounded overflow-hidden p-4 mx-auto">
        ...
        <form onSubmit={handleSubmit} className="grid gap-4 mt-5">
          ...
          <button className="bg-primary text-lg px-4py-1 hover:bg-seconda rounded text-white mt-2 font-bold leading-relaxed tracking-wider">
            Register
          </button>
        </form>
